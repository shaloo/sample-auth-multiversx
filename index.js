...
let provider
const auth = new AuthProvider('xar_dev_34d9239b56fdd243a5e590f249439f6a4d151074')
console.log({ auth })
...
async function sendTransaction() {
  ...
  const params = {
    transaction: {
      ...
      sender: from,
      receiver:
        'erd158h3u8g70p2ezqualx36q88v3am7c8xt597lpuv2503qfpcw6y9qk26qcm',
      value: '0.01',
      chainID: 'T',
      data: 'helloWorld-from Shaloo',
      version: 1,
    },
  }
